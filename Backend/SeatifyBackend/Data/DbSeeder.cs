    ...
    public class DbSeeder
    {
        public static void Seed(AppDbContext ctx)
        {
            ...
            if (!ctx.Appearances.Any())
            {
                ...
                {
                    new Appearance { Id = "app-01", OrganizerId = "org-id-01", Name = "Ocean Blue", PrimaryColor = "#3b82f6", AccentColor = "#0ea5e9", BackgroundColor = "#f1f5f9", SurfaceColor = "#ffffff", TextColor = "#0f172a", SecondaryColor = "#64748b", ThemePreset = "Ocean Blue", FontFamily = "Inter", BannerImageUrl = "https://files.123freevectors.com/wp-content/original/164510-dark-blue-texture-background.jpg", IsDefault = true, CreatedAtUtc = DateTime.UtcNow, UpdatedAtUtc = DateTime.UtcNow },
                    new Appearance { Id = "app-02", OrganizerId = "org-id-01", Name = "Midnight Pro", PrimaryColor = "#8b5cf6", AccentColor = "#22d3ee", BackgroundColor = "#0f172a", SurfaceColor = "#1e293b", TextColor = "#f8fafc", SecondaryColor = "#334155", ThemePreset = "Midnight Pro", FontFamily = "Roboto", IsDefault = false, CreatedAtUtc = DateTime.UtcNow, UpdatedAtUtc = DateTime.UtcNow },
                    new Appearance { Id = "app-03", OrganizerId = "org-id-01", Name = "Forest", PrimaryColor = "#10b981", AccentColor = "#84cc16", BackgroundColor = "#ecfdf5", SurfaceColor = "#ffffff", TextColor = "#064e3b", SecondaryColor = "#065f46", ThemePreset = "Forest", FontFamily = "Outfit", IsDefault = false, CreatedAtUtc = DateTime.UtcNow, UpdatedAtUtc = DateTime.UtcNow },
                    new Appearance { Id = "app-04", OrganizerId = "org-id-01", Name = "Sunset", PrimaryColor = "#f97316", AccentColor = "#f43f5e", BackgroundColor = "#fff7ed", SurfaceColor = "#ffffff", TextColor = "#431407", SecondaryColor = "#9a3412", ThemePreset = "Sunset", FontFamily = "Inter", IsDefault = false, CreatedAtUtc = DateTime.UtcNow, UpdatedAtUtc = DateTime.UtcNow }
                };
